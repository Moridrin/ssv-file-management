...
class DMS
{
    ...
    {
        ?>
        <tr data-path="<?= BaseFunctions::escape($path, 'attr') ?>" class="click-navigate no-menu">
    ...
    {
        ?>
        <tr class="click-navigate folder" data-path="<?= BaseFunctions::escape(BaseFunctions::decodeUnderscoreBase64($encodedItem['path']), 'attr') ?>">
    ...
    {
        ?>
        <tr class="click-open file" data-path="<?= BaseFunctions::escape(BaseFunctions::decodeUnderscoreBase64($encodedItem['path']), 'attr') ?>" data-filename="<?= BaseFunctions::escape($itemName, 'attr') ?>">
            <td class="item-name" title="<?= BaseFunctions::escape($itemName, 'attr') ?>">
                <span>
                    <svg>
